...
public class FertilizerBillBean implements Serializable {
	...
	private Double newbalance_status;
	...
	public FertilizerBillBean(Long pkfertilizerBillId, String customerName,
			...
			String paymentMode, String nameOnCheck, Long checkNo, Long cardNo,
			String accNo, String bankName, Long catId, Long supplierId,
			Long fkGoodsReceive, Long barcode, String productName,
			String company, Double salePrice, Double mrp, Long quantity,
			Double totalInGrid, Double taxPercentage, Double weight,
			Long billNo, Date insertDate, String expiryDate,
	...
	public Double getNewbalance_status() {
		return newbalance_status;
	}

	public void setNewbalance_status(Double newbalance_status) {
		this.newbalance_status = newbalance_status;
	}
