...
public class SeedPesticideBillBean {
	...
	private Double seedBalance_status;
	private String CustName;
	private Double seedinterestrate;
	private String unit;
	...
	public Double getSeedinterestrate() {
		return seedinterestrate;
	}

	public void setSeedinterestrate(Double seedinterestrate) {
		this.seedinterestrate = seedinterestrate;
	}
	...
	public Double getSeedBalance_status() {
		return seedBalance_status;
	}

	public void setSeedBalance_status(Double seedBalance_status) {
		this.seedBalance_status = seedBalance_status;
	}
