 ...
 */ 
	response.setContentType("application/pdf");
	String billnum = (String) session.getAttribute("billNum");
	...
	try {
		...
		table_cell = new PdfPCell(new Phrase("Bill No: " + billnum, Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
 ...
 */
		...
		table_cell2 = new PdfPCell(new Phrase("Mr/Mrs/Ms. " + cn, font12));
