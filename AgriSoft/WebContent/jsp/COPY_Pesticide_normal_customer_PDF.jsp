 ...
 */
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select customer_name, pesticide_billing.product_name, pesticide_billing.village, pesticide_billing.sale_price,pesticide_billing.batch_number ,pesticide_billing.company, pesticide_billing.weight,pesticide_billing.unit, pesticide_billing.quantity, pesticide_billing.salePriceWithoutTax, pesticide_billing.total_per_product, pesticide_billing.total_all_product, pesticide_billing.transportation_expense, pesticide_billing.hamali_expense, pesticide_billing.gross_total, pesticide_billing.tax_percentage,pesticide_billing.hsn ,pesticide_billing.expiry_date,pesticide_billing.igstPercentage,pesticide_billing.insert_date from pesticide_billing where bill_no ='"+billno+"' AND PayCustType='"+paycusttype+"' AND customer_type='"+custtype+"'");
	...
	/* 	String custName;
		...
		while (rs.next()) {
			if (b < 10) {
				...
				table_cell4.setHorizontalAlignment(Element.ALIGN_CENTER);
				table_cell4.setBorder(table_cell3.NO_BORDER);
				table_cell4.setBorderWidth(1f);
				table_cell4.setPaddingTop(2);
				table_cell4.setPaddingBottom(2);
				table4.addCell(table_cell4);
				...
				if (b < 20) {
					...
					String batch_number = rs.getString("batch_number");
					table_cell3 = new PdfPCell(new Phrase(batch_number, font10NoBold));
					table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell3.setBorder(table_cell3.NO_BORDER);
					table_cell3.setBorderWidth(1f);
