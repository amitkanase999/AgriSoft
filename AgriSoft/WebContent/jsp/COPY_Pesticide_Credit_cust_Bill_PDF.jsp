...
<%
	...
	/* Long billno = (Long)session.getAttribute("billNum"); */
	String billno = (String)session.getAttribute("billNum");
	out.println("bill no"+billno);
	System.out.println("bill no in pdf vikas ++++++++"+billno);
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select pesticide_billing.customer_name, pesticide_billing.product_name, pesticide_billing.village, pesticide_billing.sale_price,pesticide_billing.batch_number ,pesticide_billing.company, pesticide_billing.weight,pesticide_billing.unit, pesticide_billing.quantity, pesticide_billing.salePriceWithoutTax, pesticide_billing.total_per_product, pesticide_billing.total_all_product, pesticide_billing.transportation_expense, pesticide_billing.hamali_expense, pesticide_billing.gross_total, pesticide_billing.tax_percentage,pesticide_billing.hsn ,pesticide_billing.expiry_date,pesticide_billing.igstPercentage from pesticide_billing where bill_no ="+billno);
