...
<div class="container" style="float: left">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#NomCust"><h4 style="color: blue">All Fertilizer Customer Bill Copy</h4></a></li>
			...
			<form action="" method="post" name="genIn">
				...
				<div class="row" style="margin-top: 25px;">
					<div class="col-md-offset-2">
						...
						<div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="input-group">
									...
									</span> <select class="form-control" id="paycusttype" onchange="getbillno()">
										<option value="selected">-Select Type--</option>
						...
						<div class="col-md-3">
							<input list="ferti_bill_drop" id="BillNo" class="form-control">
							<datalist id="ferti_bill_drop">
								<%-- <%
						...
						<div class="col-md-3 col-md-offset-3" style="margin-top: 25px;"
							align="center">
							<button type="button" onclick="normalCustFertilzerBillCOPY()"
				...
				<div class="row" style="margin-top: 25px;">
					<div class="col-md-offset-2">
						...
						<div class="col-md-4 col-md-offset-3" style="margin-top: 25px;"
							align="center">
							<button type="button" onclick="creditCustFertilzerBillCOPY()"
								name="btn" class="btn btn-success"
								style="width: 125px; height: 45px;">Print</button>
						</div>
					</div>
