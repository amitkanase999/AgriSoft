...
<%@page import="com.Fertilizer.hibernate.UserDetailsBean"%>
                ...
                <div class="row">
                    ...
                    <h3>Sale</h3>
                        <div class="white-box analytics-info" style="padding: 5px;width: 170px;text-align: center;
                        ">
                            <h3 class="box-title" style="padding-top: 13px;">FERTILIZER</h3>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                    <h3>Cash</h3>
                    <div class="white-box analytics-info" style="padding: 5px;text-align: center;width: 120px;">
                ...
                <!--/.row -->
                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        ...
                        <div class="white-box analytics-info" style="padding: 5px;width: 170px;text-align: center;
                        ">
                            <h3 class="box-title" style="padding-top: 13px;">Seed</h3>
                 ...
                 <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12" >
                        ...
                        <div class="white-box analytics-info" style="padding: 5px;width: 170px;text-align: center;">
                            <h3 class="box-title" style="padding-top: 13px;">Pesticide</h3>
