 		...
 		<div class="row">
			<div align="center" style="margin-top: 75px">
			 ...
			 <ul class="nav nav-tabs">
			 	<li class="active"><a data-toggle="tab" href="#NomCust"><h4 style="color:blue">All Pesticide Customer Bill Copy</h4></a></li>
						...
						<div class="row" style="margin-top: 25px;">
							...
							<div class="col-md-3">
								<div class="input-group">
									...
									</span> <select class="form-control" id="paycusttype" onchange="getbillnoForPesticide()">
										<option value="selected">-Select Type--</option>
								...
								<div class="col-md-3">
									<input list="PestiBillNo_drop" id="BillNum" class="form-control">
									<datalist id="PestiBillNo_drop"></datalist>
									<%-- <%
