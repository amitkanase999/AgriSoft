 ...
 */
	...
	try {
		...
		ResultSet rs = stmt.executeQuery(
				"select customer_name, fertilizer_billing.product_name, fertilizer_billing.sale_price,fertilizer_billing.village, fertilizer_billing.company, fertilizer_billing.weight,fertilizer_billing.unit, fertilizer_billing.quantity, fertilizer_billing.salePriceWithoutTax, fertilizer_billing.total_per_product, fertilizer_billing.total_all_product, fertilizer_billing.transportation_expense, fertilizer_billing.hamali_expense, fertilizer_billing.gross_total , fertilizer_billing.tax_percentage,fertilizer_billing.hsn,fertilizer_billing.igstPercentage from fertilizer_billing where bill_no ="
						+ billno);
