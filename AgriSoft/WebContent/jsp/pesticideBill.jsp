...
<link rel="stylesheet"
	href="/AgriSoft/staticContent/css/ui.jqgrid.css">
<script type="text/javascript"
...
<script type="text/javascript"
	src="/AgriSoft/staticContent/js/pesticideBill.js"></script>
...
<body onload="pageLoad();fetchPesticideProductAgainstDefaultGodown();">
<div style="padding-bottom: 75px;">
<!-- 	getProductNameForCashForPesti();getProductNameForCreditForPesti() -->
	...
	<div class="container col-sm-offset-1 ">
		...
		<form class="form-horizontal" method="post" action="" name="pestiBillingform">
		<div style="    margin-left: 434px; margin-top: 11px;padding-bottom: 10px;">
			<div class="col-md-4" style="margin-left: -142px;width: 345px;">
		...
		<div id="CashCustDetail">
			...
			<!-- 		<div class="row form-group">
						...
						<div class="col-md-8">
							<div class="input-group">
								<span class="input-group-addon"> <i
									...
									onchange="getProductDetailForSeedBillForPesti()" > onchange="getBatchNumberAndStockForPesti()"
								</select>
							</div>
						</div>
					</div> -->
					...
					<div class="row form-group">
						...
						<div class="col-md-8">
							...
							<%-- 		<%
								...
								List ProductList=FertiProDao.getAllPesticideProductList(); 
								
									Date date = new Date();
							
							%> --%>

								<input list="pesti_pro_drop" class="form-control" id='proName' name="proName" onchange="getProductDetailForSeedBillForPesti()" onfocus="this.value=''">
								<datalist id="pesti_pro_drop">
							...
							%>
									<option  data-value="<%=bean.getPk_stock_id()%>"><%=bean.getProduct_name() %>,
										<%=bean.getBatchno()%>,Qty =,<%=bean.getQuantity()%>,<%=DateFormat.getDateInstance().format(bean.getExpiryDate())%>,Packing =,<%=bean.getPacking()%>,<%=bean.getUnitName()%>
									</option>
									<%
				      			}
				    		%> --%>
				...
				<label class="col-md-3 control-label"  for="barcode" ><b>Barcode</b></label>  
					            		...
					            		<label class="col-md-2 control-label"  for="barcode" ><b>Bill Date<sup>*</sup></b></label>  
					            		  	 <div class="col-md-3">
					            		  	 	<%
											...
											<div class="input-group">
												<span class="input-group-addon">
					              				...
					              				<input id="billdate" name="billdate" value="<%= todayDate%>" class="form-control input-md" type="Date" >
					            			</div>
					            		</div>
	           	...
	           	$("#card_no").hide();
					...
					<div class="form-group row">
						<div class="col-md-10 text-center">
							<input type="button" id="save1" name="btn1" style="font-size: 25" accesskey="y"
			...
			<!-- Wholesale Customer DropDown -->
				...
				<!-- End wholesale dropdown -->
					...
					<div class="row form-group">
						...
						<label class="col-md-2 control-label" for="aadharNo1">Aadhar No.
						</label>
						<div class="col-md-3">
							<div class="input-group">
								<span class="input-group-addon"> No. </span> <input
					...
					<div class="row form-group">
						...
						<div class="col-md-8">
							...
							<%-- 	<%
								...
								ProductDetailsDao pestProDao1=new ProductDetailsDao();
								List ProductList1=pestProDao1.getAllPesticideProductList(); 
								
									Date date1 = new Date();
							
							%> --%>

								<input list="pesti_pro_drop" class="form-control" id='proName1' name="proName" onchange="gridForCreditForPesti()" onfocus="this.value=''">
								<datalist id="pesti_pro_drop">
					            		...
					            		<label class="col-md-2 control-label"  for="barcode" ><b>Bill Date<sup>*</sup></b></label>  
											...
											<div class="input-group">
												<span class="input-group-addon">
					              				...
					              				<input id="billdate1" name="billdate1" value="<%= todayDate%>"class="form-control input-md" type="Date" >
					            			</div>
					            		</div>
        ...
        <script type="text/javascript">
         $('#batchNo1').on('change','select', function() { 
        	 gridForCredit();  // get the current value of the input field.
					...
					<div class="form-group row">
						<div class="col-md-10 text-center">
							<input type="button" id="save2" name="custbtn" accesskey="u"
								style="font-size: 25"
								class="btn btn-large btn-success button-height-width"
