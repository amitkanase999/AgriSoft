...
<h3>Low Stock Report</h3>
	<table class="display col-md-offset-2" border="1" style="margin-left: 165px;margin-top: 60px;">
		...
		<tr style="color: black;">
			<td style="font-size: 19;"><%=goodsForNotification1.getProductName()%></td>
			<td style="font-size: 19;"><%=goodsForNotification1.getCompany()%></td>
			<td style="font-size: 19;"><%=goodsForNotification1.getWeight()%></td>
			<td style="font-size: 19;"><%=goodsForNotification1.getBatchNumber() %></td>
			<td style="font-size: 19;"><%=goodsForNotification1.getStock() %></td>
